...
public class ServerMetaInfo {
    ...
    @SerializedName("feature.non_email_login") private final boolean emailLogin = true;
    @SerializedName("feature.legacy_skin_api") private final boolean legacySkinApi = false;
    @SerializedName("feature.no_mojang_namespace") private final boolean mojangNamespace = true;
