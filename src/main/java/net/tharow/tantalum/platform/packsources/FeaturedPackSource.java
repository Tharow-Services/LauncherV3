...
public class FeaturedPackSource implements IPackSource {
    private final String platform;
    private final Map<String, Integer> resultPriorities = new HashMap<>();

    public FeaturedPackSource(String platform) {
        this.platform = platform;
    }

    @Override
    public String getSourceName() {
        return "Get Featured Modpacks";
    }
    ...
    public Collection<PackInfo> getPublicPacks() {
        ...
        try {
            results = HttpPlatformApi.getFeaturedPacks(platform);
