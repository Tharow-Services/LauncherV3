...
import net.tharow.tantalum.minecraftcore.microsoft.auth.model.*;
...
import static net.tharow.tantalum.launchercore.exception.MicrosoftAuthException.ExceptionType.*;
