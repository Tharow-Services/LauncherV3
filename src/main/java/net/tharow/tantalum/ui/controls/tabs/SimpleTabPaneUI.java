...
package net.tharow.tantalum.ui.controls.tabs;
...
public class SimpleTabPaneUI extends BasicTabbedPaneUI {
    ...
    protected void paintTabBackground(Graphics g, int tabPlacement,
        ...
        switch (tabPlacement) {
            case LEFT : g.fillRect(x + 1, y, w - 1, h - 2); break;
            case BOTTOM : g.fillRect(x, y, w - 2, h - 1); break;
            default : g.fillRect(x, y, w - 2, h - 2); break;
        }
    }
